...
interface RegistrationSuccessPopup21dayProps {
    isOpen: boolean;
    onClose: () => void;
...
const RegistrationSuccessPopup21day: React.FC<RegistrationSuccessPopup21dayProps> = ({
    isOpen,
    onClose,
    status,
    language,
...
export default RegistrationSuccessPopup21day;
